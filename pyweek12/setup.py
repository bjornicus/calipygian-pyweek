...
PACKAGEDATA = {
    ...
    'package_dir': {'ennead': 'ennead',
                   },
    'packages': ['ennead',
                ],
    'scripts': ['scripts/ennead'],
}
...
_DATA_DIR = os.path.join('ennead', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'ennead': data_dirs}
